...
console.log((0, _momentDefault.default)().format("MMMM Do YYYY, hh:mm:ss a"));
console.log((0, _momentDefault.default)().format("dddd"));
console.log((0, _momentDefault.default)().format("MMM Do YY"));
console.log((0, _momentDefault.default)("2020-01-01", "YYYY-DD-MM", true).isValid());
console.log((0, _momentDefault.default)("2020-14-01", "YYYY-DD-MM", true).isValid());
console.log((0, _momentDefault.default)().add(7, "days").calendar());
console.log((0, _momentDefault.default)().add(7, "months").calendar());
console.log((0, _momentDefault.default)().add(7, "years").calendar());
console.log((0, _momentDefault.default)().subtract(7, "days").calendar());
console.log((0, _momentDefault.default)().subtract(7, "months").calendar());
console.log((0, _momentDefault.default)().subtract(7, "years").calendar());
function diff(a, b) {
    let d1 = (0, _momentDefault.default)(a);
    let d2 = (0, _momentDefault.default)(b);
    console.log(d2.diff(d1, "days"));
}
diff("2014-11-11", "2015-09-11");
diff("2014-11-27", "2015-09-16");
console.log((0, _momentDefault.default)("2020-01-01").isAfter("2018-01-01"));
console.log((0, _momentDefault.default)([
    2019
]).isLeapYear());
console.log((0, _momentDefault.default)([
    2020
...
},{"moment":"jwcsj","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jwcsj":[function(require,module,exports) {
...
},{}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire0cd5")
